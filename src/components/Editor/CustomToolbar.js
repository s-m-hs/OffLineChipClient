const CustomToolbar = ({ onInsertHTML }) => (
  <div id="toolbar">
    ...
    <button className="ql-html" title="Insert HTML" onClick={onInsertHTML}>
      <span
        className="centerr"
        style={{
          paddingLeft: "20px",
      ...
      >
        <i class="fa-solid fa-film fa-md"></i>IFrame
      </span>
    </button>
  </div>
);
